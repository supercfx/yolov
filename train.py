...
from _utils.dataloader import yolo_dataset_collate, YoloDataset
...
def get_anchors(anchors_path):
    ...
    anchors_names = [float(x) for x in anchors_names.split(',')]
    return np.array(anchors_names).reshape([-1,3,2])
...
def fit_ont_epoch(net,yolo_losses,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    with tqdm(total=epoch_size,desc=f'Epoch {epoch + 1}/{Epoch}',postfix=dict,mininterval=0.3) as pbar:
        for iteration, batch in enumerate(gen):
            ...
            f = open('/home/susiyu/Desktop/YOLOV4-tiny/YOLOV4-tiny/iter_loss.txt', 'a')
            f.write("{}_{}\n".format((epoch * epoch_size + iteration), loss))
            f.close()
            total_loss += loss
    ...
    with tqdm(total=epoch_size_val, desc=f'Epoch {epoch + 1}/{Epoch}',postfix=dict,mininterval=0.3) as pbar:
        for iteration, batch in enumerate(genval):
            ...
            pbar.update(1)
        # writer.add_scalar('Val_loss', loss, (epoch * epoch_size_val + iteration))
        f = open('/home/susiyu/Desktop/YOLOV4-tiny/YOLOV4-tiny/iter_loss_val.txt', 'a')
        f.write("{}_{}\n".format((epoch * epoch_size_val + iteration), loss))
        f.close()
    net.train()
...
if __name__ == "__main__":
    ...
    annotation_path = '/home/susiyu/Desktop/YOLOV4-tiny/YOLOV4-tiny/traffic-yolov4-tiny-pytorch/2007_train.txt'

    #-------------------------------#
    #   获得先验框和类
    #-------------------------------#
    anchors_path = '/home/susiyu/Desktop/YOLOV4-tiny/YOLOV4-tiny/traffic-yolov4-tiny-pytorch/model_data/yolo_anchors.txt'
    classes_path = '/home/susiyu/Desktop/YOLOV4-tiny/YOLOV4-tiny/traffic-yolov4-tiny-pytorch/model_data/new_classes.txt'
    ...
    #   权值文件的下载请看README
    #-------------------------------------------#
    # model_path = "model_data/yolov4_ny_coco.pth"
    model_path = "/home/susiyu/Desktop/YOLOV4-tiny/YOLOV4-tiny/traffic-yolov4-tiny-pytorch/model_data/yolov4_tiny_weights_coco.pth"
    # 加快模型训练的效率
    ...
    print('Total parameters: %.4f'%total_parameters)
    ...
    # writer = SummaryWriter(log_dir='visual', flush_secs=60)
